...
set out "stim1instnomrt_detbal.tex"
...
set arrow 2 from 0,0 to 0, 115 arrowstyle 1
...
plot "< awk 'BEGIN{i=0}{if(i%20==0){print $0}; i++}' ../varmcnomrt_detbal/mt_val_dim/stim1_10.dat" u 0:1 w p pt 7 ps 0.1 lc rgb "#0000FF" 
