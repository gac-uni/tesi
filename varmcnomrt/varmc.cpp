...
class Walker{
    public:      
        ...
        double * ken(double * gradlogprex, double * gradlogprey, double * gradlogprez){
            double * out;
            out = new double[3];
            /*
            out:
...
int montecarlo(Walker * walker, double tau, double * gradlnpsiprex, double * gradlnpsiprey, double * gradlnpsiprez){
...
int main(int argc, char ** argv){
    ...
    for(int i=0; i<npassi; i++){
        ...
        montecarlo(&walker, tau, gradlogprex, gradlogprey, gradlogprez);
        // --- calcolo osservabili ---
        ...
        double * tempken=walker.ken(gradlogprex, gradlogprey, gradlogprez);
        ...
        if(i%(int)(npassi/100 + 0.5)==0){            
            std::cout<<"\rcompletamento: " << (double)i/(double)npassi*100. << "%" << std::flush;
        }
    }
    std::cout<<std::endl;
